...
class BLT_Popups_Meta {
	...
	public static function render( $post ) {
		...
		<div class="blt-popup-metabox">
			...
			<fieldset class="blt-popup-group">
				<legend><?php esc_html_e( 'Image & Destination', 'blt-popups' ); ?></legend>
				...
				<p class="blt-popup-field">
					<label><input type="checkbox" name="blt_popup_dest_new_tab" value="1" <?php checked( (bool) $get( 'dest_new_tab' ) ); ?> /> <?php esc_html_e( 'Open destination in a new tab', 'blt-popups' ); ?></label>
				</p>

				<p class="blt-popup-field">
					<label><input type="checkbox" name="blt_popup_cta_enabled" id="blt_popup_cta_enabled" value="1" <?php checked( (bool) $get( 'cta_enabled' ) ); ?> /> <?php esc_html_e( 'Show a call-to-action button (in addition to the clickable image)', 'blt-popups' ); ?></label>
				</p>
			...
			<fieldset class="blt-popup-group">
				<legend><?php esc_html_e( 'Sizing & Appearance', 'blt-popups' ); ?></legend>
			...
			<fieldset class="blt-popup-group">
				<legend><?php esc_html_e( 'Schedule', 'blt-popups' ); ?></legend>
			...
			<fieldset class="blt-popup-group">
				<legend><?php esc_html_e( 'Targeting', 'blt-popups' ); ?></legend>
			...
			<fieldset class="blt-popup-group">
				<legend><?php esc_html_e( 'Frequency', 'blt-popups' ); ?></legend>
